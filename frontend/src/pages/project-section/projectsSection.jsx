    ...
    <>
      <div className="project-section">
        {createdProjectIsDone && (
          <Message text={`${createdProjectname} Project Is Created`} />
        )}
        {/* <div className="top-projects-section">
          <div className="project-section-title">Projects Section</div>
          <div className="new-project" onClick={openProjectModal}>
            + new project
          </div>
        </div> */}
